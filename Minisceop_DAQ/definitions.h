...
#define SS_FC_TOTAL_SIZE_CLASS_DSCR        (0x0E + 0x1B + SS_YUY2_STILL_DESCR_SIZE +\
...
#define SS_TOTAL_SIZE_CONFIG_DSCR        (0x09 + 0x8A + SS_FC_TOTAL_SIZE_CLASS_DSCR + 35) //SS_TOTAL_SIZE_CLASS_DSCR)
#else
